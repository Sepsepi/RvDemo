                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between mb-1">
                          <p className="font-semibold text-sm">{conv.partner?.full_name || 'Renter'}</p>
                          {conv.unread_count > 0 && (
                            <Badge className="bg-black text-white">{conv.unread_count}</Badge>
                          )}
                        </div>
                        <p className="text-xs text-gray-500 mb-1">{conv.asset?.name}</p>
              ...
              <CardHeader className="border-b">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{selectedConversation.asset?.name}</p>
                  </div>
                </div>
              </CardHeader>
                    ...
                    return (
                      <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                        ...
                        >
                          ...
                          <p className={`text-xs mt-1 ${isMe ? 'text-gray-300' : 'text-gray-500'}`}>
